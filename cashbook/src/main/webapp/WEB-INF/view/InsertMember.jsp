	...
	<div class = "container">
		...
		<form method = "post" action = "<%=request.getContextPath()%>/InsertMemberController">
			<table class ="table table-bordered">
				...
				<tr> 
					<th class = "table-info text-center">성별</th>
					<td>
			...
			<a href="<%=request.getContextPath()%>/LoginController" class="btn btn-info">이전</a>
			<button type="submit"  class="btn btn-info float-right top">회원가입</button>
		</form>
	</div>
</body>
</html>