...
<body>
	<div class = "container">
		...
		<span class = "float-right">
			<a href = "<%=request.getContextPath()%>/UpdateMemberController" class="btn btn-outline-info">수정</a>
			<a href = "<%=request.getContextPath()%>/DeleteMemberController" class="btn btn-outline-info">삭제</a>
		</span>
	</div>
</body>
</html>